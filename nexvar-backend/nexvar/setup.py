...
with open('nexvar/version.py') as infile:
    exec(infile.read())
...
setup(
    name='nexvar',
    version=version,
    # Only include the nexvar package; the vortex submodule is used for build purposes.
    packages=find_packages(include=["nexvar", "vortex/vortex"]),
    ...
    package_data={'nexvar': ['nexvar/configs/*.yml']},
    ...
    author='Team NexVar',
    url='https://github.com/Eldergenix/NexVar',
)
