...
def main():
    """
    Test sequence generation and scoring using the nexvar models
    Expected results (direct comparison w/o alignment):
    - NexVar 40B 1m: 91.15%
    - NexVar 7B 1m: 89.25% 
    - NexVar 1B base: 68.0%
    """
    parser = argparse.ArgumentParser(description="Test NexVar Model Generation")
    parser.add_argument("--model_name", choices=['nexvar_7b', 'nexvar_40b', 'nexvar_1b_base'], default='nexvar_7b',
                       help="Model to test (supports nexvar_7b, nexvar_40b, nexvar_1b_base)")
