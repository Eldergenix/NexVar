...
def main():
    """
    Test sequence prediction accuracy using NexVar models.
    Expected results for forward pass:
    - NexVar 40B 1m: Loss ~0.216, Accuracy ~91.67%
    - NexVar 7B 1m: Loss ~0.348, Accuracy ~86.35%
    - NexVar 1B base: Loss ~0.502, Accuracy ~79.56%
    """
    parser = argparse.ArgumentParser(description="Test NexVar Model Forward Pass")
    parser.add_argument("--model_name", choices=['nexvar_7b', 'nexvar_40b', 'nexvar_7b_base', 'nexvar_40b_base', 'nexvar_1b_base'], 
                       default='nexvar_7b',
                       help="Model to test")
    ...
    expected_metrics = {
        'nexvar_40b': {'loss': 0.2159424, 'acc': 91.673},
        'nexvar_7b': {'loss': 0.3476563, 'acc': 86.346},
        'nexvar_40b_base': {'loss': 0.2149658, 'acc': 91.741},
        'nexvar_7b_base': {'loss': 0.3520508, 'acc': 85.921},
        'nexvar_1b_base': {'loss': 0.501953125, 'acc': 79.556}
    }
